...
describe('測試【and】', function () {
    ...
    test('1111000011110000111100001 與 0000111100001111000011111 做 and 運算，結果應為 0000000000000000000000001',
         () => {
...
describe('測試【or】', function () {
    ...
    test('1111000011110000111100001 與 0000111100001111000011111 做 or 運算，結果應為 1111111111111111111111111', () => {
        const 測試位元陣列1 = new 位元陣列('1111000011110000111100001')
        const 測試位元陣列2 = new 位元陣列('0000111100001111000011111')
...
describe('測試【xor】', function () {
    ...
    test('1111000011110000111100001 與 0000111100001111000011111 做 xor 運算，結果應為 1111111111111111111111111',
         () => {
             const 測試位元陣列1 = new 位元陣列('1111000011110000111100001')
             const 測試位元陣列2 = new 位元陣列('0000111100001111000011111')
...
describe('測試【狀態】', function () {
    test('位元編號不是數值，應拋出例外：型別錯誤例外', () => {
        const 測試位元陣列 = new 位元陣列(24)
        expect(() => 測試位元陣列.狀態()).toThrow(型別錯誤)
    })

    test('位元數 24，取得位元編號 -1 的狀態，應拋出例外：索引超出範圍錯誤', () => {
        const 測試位元陣列 = new 位元陣列(24)
        expect(() => 測試位元陣列.狀態(-1)).toThrow(索引超出範圍錯誤)
    })

    test('位元數 24，取得位元編號 24 的狀態，應拋出例外：索引超出範圍錯誤', () => {
        const 測試位元陣列 = new 位元陣列(24)
        expect(() => 測試位元陣列.狀態(24)).toThrow(索引超出範圍錯誤)
    })

    test('位元數 24，取得位元編號 25 的狀態，應拋出例外：索引超出範圍錯誤', () => {
        const 測試位元陣列 = new 位元陣列(24)
...
describe('測試【解析二進位字串】', function () {
    ...
    test('1010101010101010101010101，應能解析為 1010101010101010101010101', () => {
...
describe('測試【設定狀態】', function () {
    ...
    test('位元數 24，設定位元編號 -1 的狀態，應拋出例外：索引超出範圍錯誤', () => {
        const 測試位元陣列 = new 位元陣列(24)
        expect(() => 測試位元陣列.設定狀態(-1)).toThrow(索引超出範圍錯誤)
    })

    test('位元數 24，設定位元編號 24 的狀態，應拋出例外：索引超出範圍錯誤', () => {
        const 測試位元陣列 = new 位元陣列(24)
        expect(() => 測試位元陣列.設定狀態(24)).toThrow(索引超出範圍錯誤)
    })

    test('位元數 24，設定位元編號 25 的狀態，應拋出例外：索引超出範圍錯誤', () => {
        const 測試位元陣列 = new 位元陣列(24)
...
describe('測試【轉為二進位字串】', function () {
    test('1111000011110000111100001，結果應為 1111000011110000111100001', () => {
        const 測試位元陣列 = new 位元陣列('1111000011110000111100001')
